...
export default function RomanCurtainsPage() {
  return (
    <SubMenuPageTemplate
      ...
      images={["/card-roman-blinds-linen.jpg", "/card-roman-curtains-teal.jpg"]}
      imageAltText={["Custom Belgian Linen Roman Shade in Dubai Villa", "Light Filtering Teal Linen Roman Curtain"]}
