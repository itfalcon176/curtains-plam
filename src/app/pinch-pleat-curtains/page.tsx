...
export default function PinchPleatCurtainsPage() {
  return (
    <SubMenuPageTemplate
      ...
      subtitle="Timeless Artisanal Pinch Pleats for Formal Luxury Living Rooms & Master Suites"
      description="Hand-sewn pinch pleat headers create structured, opulent folds that cascade down your windows. The quintessential luxury tailoring choice for grand Dubai mansions and Palm Jebel Ali villas."
      whatIsHeading="What are Pinch Pleat Curtains?"
      whatIsText={[
        "Pinch Pleat Curtains are a classic custom drapery style where groups of fabric folds are tightly hand-stitched together at regular intervals along the top header. This creates stiffened, permanent fan-shaped pleats that retain their rich shape permanently.",
      ...
      imageAltText={["Artisanal Pinch Pleat Header Detail", "Formal Grand Villa Salon with Pinch Pleat Drapes"]}
      whyNeedHeading="Why You Need Pinch Pleat Curtains in Dubai"
      whyNeedPoints={[
        "Hand-Crafted Luxury Tailoring: Each pleat is hand-measured and stitched by master drapery artisans.",
